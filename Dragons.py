...
def intro():
	...
	print("With your trust sword at your side and trust backpack on your back, you look upon the fearsom entrance to the cave.")
	print()
...
def goDownChimney():
	if dragonLocation =='upper':
		...
		raw_input()
		print('The smoke keeps getting thicker and thicker. It is getting hard to breathe... (press enter)')
		raw_input()
		print('You have become lost in the smoke, and start coughing. You cannot get any air!... (press enter)')
		raw_input()
		print('ACK! You have suffocated to death! It was kind of dumb to climb into that smokey chimney. Idiot!')
		return
...
def upperArea():
	print("You are standing in a chamber near the top of the cave. There is a rop ladder to a chmney hole in the ceiling that leads outside.")
	if dragonLocation == 'upper':
		print("The dragon is standing in the chamber! Smoke comes out of his nostrils and floats up and out the hold in the ceiling.")
		pause()
		faceDragon()
	if dragonLocation == 'lower':
		print()
